...
### Need the XLi_match_mut.xlsx file
XLi_match_mut <- read_excel("XLi_match_mut.xlsx")
Obs_vs_Exp_mat<-left_join(Obs_vs_Exp_mat,XLi_match_mut[,1:3],by=c("mut_name"="mut_name"))
