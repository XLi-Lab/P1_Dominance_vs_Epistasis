...
### Setting the different parameters used in Model 1 - Model 3
...
para_All<-list(para_dGF_wt,para_pr2,para_pr2) # Put all the parameters into a list

### Generate wild-type phenotype under different parameters and with different non-linearity
### m:Model, i:parameter, k:non-linearity, put all the wild-type phenotype data into a list
wt_All<-list()
data_save<-list()
data_save_x<-list()
for (m in 1:3) {
